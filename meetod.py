...
st.header('Sündimus rahvastikuprognoosis')
st.markdown('''
Rahvastikuprognoosides kasutatav kohort-komponent meetod on deterministlik viis rahvastiku vanuselise koosseisu ja suuruse prognoosimiseks teadaolevate ja 
...
suremus ja rände muutust muutuva vanusstruktuuri juures. 

Arusaadavalt tuleviku sündimus, rändevood ja suremus ei ole teada, mistõttu on prognoosimiseks vaja nende kohta teha eeldusi. 

Käesolev prognoosimudel võimaldab teatud piirides sündimust puudutavate eeldustega manipuleerida. Näiteks anda prognoosimiseks ette:
...
oodatava eluea tõusu, kuigi see oleks loogiline. Teiseks, sisse- ja väljaränne, mis võiks omakorda vanuskoostist mõjutada, 
...
### Leslie maatriks            
st.markdown('''
            Leslie maatriks (https://en.wikipedia.org/wiki/Leslie_matrix) on niisugune maatriks, mille ridade arv vastab 
...
st.markdown('''
            ...
            See aga tähendab, et prognoositava perioodi jooksul ei muutu sündimuskordajad, mis ei ole tõenäoliselt realistlik.
                  Antud juhul kasutame siiski korduvaid ühe aasta prognoose, kuna maatriksis olevad sündimuskordajad muutuvad igal aastal. 
                  See tähendab, et igal aastal arvutatakse uus Leslie maatriks, mis vastab selle aasta eeldatavatele sündimuskordajatele ja 
                  ellujäämise tõenäosustele. See võimaldab prognoosida rahvastiku muutusi dünaamilisemalt ja realistlikumalt.
                  ''')

st.markdown('''Seejuures tekib probleem, et summmaarse sündimuskordaja (TFR) asemel on Leslie maatriksis
            vanusepõhised sündimuskordajad (ASFR). TFR on ASFR-i summa üle kõigi vanusvahemike. Järelikult peame eeldatud tuleviku TFR-i
            teisendama vanuspõhisteks sündimuskordajateks, et need sobiksid Leslie maatriksisse.  
            ''')
...
- Keskmine sünnituseas (MAB)
- Keskmise sünnitusea standardhälve (sdMAB)
''')
...
st.write("Neid kolme sisendit (TFR, MAB ja sdMAB) saab kasutaja prognoosi tegemisel määrata.")
